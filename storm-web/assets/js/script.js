...
function check_new_version(){
    ...
    function check_version_on_git(){
        $.get("https://raw.githubusercontent.com/Alphaverse8qn/stormm/main/Settings.json",function(data){
            new_version = JSON.parse(data)
                if(last_version < new_version.version){
                    show_notif("New version available :)","https://github.com/Alphaverse8qn/stormm",true)
                }
        })
    }
