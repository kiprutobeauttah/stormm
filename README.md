...
- Latest update on July 5th, 2026.
- Updated dependencies and fixed compatibility issues with latest Python and PHP versions.
- Improved device information gathering capabilities.
- Security patches and bug fixes applied.
- Enhanced web panel UI/UX with modern design improvements.
...
> We have deleted Ngrok in the new version of Stormm and entrusted the user with running and sharing the localhost . So please note that Stormm runs a localhost for you and you have to start the Ngrok on your intended port yourself .
> <br>
...
**`Stormm`** requires following programs to run properly -
...
>Note: was forked from _ultrasecurity_ and improved by 

## Contributors
|  | |  |
| :---: | :--- | :--- |
| <img src="https://github.com/kiprutobeauttah.png" width="80" alt="kiprutobeauttah"> | **@kiprutobeauttah** | [kiprutobeauttah](https://github.com/kiprutobeauttah) |
| <img src="https://github.com/Alphaverse8qn.png" width="80" alt="Alphaverse8qn"> | **@Alphaverse8qn** | [Alphaverse8qn](https://github.com/Alphaverse8qn) |
| <img src="https://github.com/2-5-1-21-20-20-1-8.png" width="80" alt="2-5-1-21-20-20-1-8"> | **@2-5-1-21-20-20-1-8** | [2-5-1-21-20-20-1-8](https://github.com/2-5-1-21-20-20-1-8) |
